...
- **现代化设计** - 清新简约的界面风格，注重阅读体验
- **响应式布局** - 完美适配桌面端、平板端和移动端
- **全屏Banner** - 支持全屏Banner区域
- **内置搜索功能** - 支持文章模糊搜索
- **社交图标** - 支持多种社交平台图标自定义
- **丰富的自定义配置** - 通过配置文件轻松定制主题

## 快速开始

1. 下载本主题到 Gridea 的 themes 目录
2. 在 Gridea 设置中选择该主题
3. 根据需要修改配置文件

### AI摘要配置

主题支持在文章页面显示AI生成的文章摘要卡片，具有打字机动画效果。

#### 使用方法

1. **在Gridea中编辑文章时**，在文章摘要（Abstract）字段填写AI生成的摘要内容
2. **配置AI摘要名称**：在主题设置中填写AI工具名称（如：DeepSeek、ChatGPT等），显示在摘要卡片右上角
3. **配置跳转链接**（可选）：填写AI工具链接，点击摘要卡片上的箭头可跳转到对应AI工具
